...
<div class="container px-0 py-5">
	...
	<div class="row">
		<?php
		$home_our_solution = new WP_Query(
			array(
		...
		while ($home_our_solution->have_posts()) :
			$home_our_solution->the_post();
				...
				<div class="card team-card h-100 mx-2 rounded-0">
					...
					<div class="card-body">
						<h5 class="mb-3" style="font-weight: 700;">
							<?php echo esc_html(get_field('gallery_title')); ?>
						</h5>
					</div>
				</div>
			</div>
					...
					<div class="card wow fadeInLeft" data-wow-delay="0.4s">
						...
						<div id="collapseFour" class="collapse" data-parent="#accordion-1">
							<div class="card-body">
								...
								strong retaining walls with proper foundation and quality
								materials.
							</div>
						</div>
					</div>
					...
					<div class="card wow fadeInLeft" data-wow-delay="0.5s">
						...
						<div id="collapseFive" class="collapse" data-parent="#accordion-1">
							<div class="card-body">
								...
								ceiling plaster and terrace plaster with smooth and durable
								finishing.
							</div>
						</div>
					</div>
				...
				<div id="accordion-2">
					<div class="card wow fadeInRight" data-wow-delay="0.1s">
						...
						<div id="collapseSix" class="collapse" data-parent="#accordion-2">
							<div class="card-body">
								Yes, we specialize in basement waterproofing and basement
								retaining wall treatment to protect underground areas from water
								damage.
							</div>
						</div>
					</div>
					...
					<div class="card wow fadeInRight" data-wow-delay="0.5s">
						...
						<div id="collapseTen" class="collapse" data-parent="#accordion-2">
							<div class="card-body">
								...
								reliable civil work and waterproofing services with quality
								assurance.
							</div>
						</div>
					</div>
